...
public class PolyConfigs {
	...
	public static final ConfigData BRIGHTNESS_BOOST = CONFIG_MAIN.getData(ConfigSection.GRAPHICS, "brightnessBoost", 0.22f, FlounderShadows.get()::getBrightnessBoost);
	...
	public static final ConfigData SHADOWMAP_DARKNESS = CONFIG_MAIN.getData(ConfigSection.GRAPHICS, "shadowmapDarkness", 0.5f, FlounderShadows.get()::getShadowDarkness);
