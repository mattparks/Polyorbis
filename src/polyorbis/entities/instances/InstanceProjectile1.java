...
public class InstanceProjectile1 extends Entity {
	...
	private static final ParticleType[] TEMPLATES = new ParticleType[]{
			new ParticleType("purple", TextureFactory.newBuilder().setFile(new MyFile(FlounderParticles.PARTICLES_FOLDER, "yellowParticle.png")).setNumberOfRows(4).create(), 1.2f, 0.10f)
	};
