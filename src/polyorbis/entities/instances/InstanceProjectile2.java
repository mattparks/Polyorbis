...
public class InstanceProjectile2 extends Entity {
	...
	public InstanceProjectile2(ISpatialStructure<Entity> structure, Vector3f rotation, float radius, Vector3f direction) {
		...
		new ComponentProjectile(this, rotation, radius, -0.7f, direction.normalize().scale(0.6f), 0.001f, 4.20f);
		new ComponentRotate(this, new Vector3f(0.3f, 1.0f, 1.0f), 0.5f);
