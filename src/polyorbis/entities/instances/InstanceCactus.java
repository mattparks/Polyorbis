...
public class InstanceCactus extends Entity {
	...
	public InstanceCactus(ISpatialStructure<Entity> structure, Vector3f rotation, float radius) {
		super(structure, Vector3f.rotate(new Vector3f(0.0f, radius - 0.2f, 0.0f), rotation, null), new Vector3f(0.0f, rotation.y, rotation.z));
		new ComponentModel(this, 0.43f, MODEL, TEXTURE, 1);
